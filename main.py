...
def check_permission(method, api, session_id):
    ...
    in_adm = True if api in ["/admin_account", "/admin_add_user", "/admin_information_change", "/admin_lecture", "/admin_pass_change", "/admin_statistic", "/admin_user_account", "/admin_user_information_change", "/create_lecture", "/create_practice", "/create_test",
                     "/edit_lecture", "/edit_test", "/information_change", "/pass_change", "/user_list", "/task_list", "/practice_answer_list", "/practice_answer", "/admin_practice", "/edit_practice", "/admin_test", "/admin_practice_answer"] else False
